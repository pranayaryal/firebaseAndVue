  ...
  <form>
    <div class="mdl-grid">
      ...
      <div class="mdl-cell mdl-cell--4-col mdl-cell--8-col-tablet">
        <div class="mdl-textfield mdl-js-textfield mdl-textfield-floating-label is-upgrade">
          <input v-model="title" id="username" type="text" class="mdl-textfield__input">
        ...
        this.$root.$firebaseRefs.cat.push(
          {
            'url': this.catUrl,
            'comment': this.title,
            'info': 'Posted by Pranay on Saturday',
